...
(async()=>{try{library=await window.newsApp.library();applyTheme();render();await refresh();}catch(e){$('connection').textContent='Nie można otworzyć biblioteki: '+e.message;$('connection').className='error';}})();
